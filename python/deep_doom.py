...
class DeepDoom:
    ...
    observation_steps = 25000  # time steps to observe before training
    ...
    learn_rate = 1e-5 
    checkpoint_path="/home/sven/checkpoint/new/" # this is the path where the checkpoints will be saved
    episodes = 152
    ...
    def train(self):
        ...
        # do a feed forward pass to get the action q values for the new state
